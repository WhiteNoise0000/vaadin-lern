...
public class SubPage2 extends VerticalLayout {
	...
	public SubPage2() {
		...
		// editor.setConfig("{\"language_url\": \"/ja.js\", \"language\": \"ja\",
		// \"elementpath\": false}");
		// editor.setWidthFull();
		// add(editor);
		...
		// WebPush配信
		TextField message = new TextField("Push配信");
		Button broadcast = new Button("配信");
		broadcast.addClickListener(e -> webPushService.notifyAll("メッセージ通知", message.getValue()));
